...
% matsetting.m
%
% Model exported on Apr 28 2016, 10:22 by COMSOL 4.2.0.150.
...
model.material('mat2').selection.named('geom1_outsideIF1_dom');
model.material('mat2').selection.named('geom1_Unionsmall_dom');
model.material('mat2').selection.named('geom1_UnionLargeEllipse1_dom');
model.material('mat3').selection.named('geom1_UnionLargeEllipse2_dom');
model.material('mat4').selection.named('geom1_DiffMatrix_dom');
